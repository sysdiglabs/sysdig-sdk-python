...
class UpdateKafkaIntegrationRequestAllOfConnectionInfo(BaseModel):
    ...
    keytab: Optional[Annotated[str, Field(strict=True, max_length=1048576)]] = Field(default=None, description="base64 encoded Kerberos keytab")
    __properties: ClassVar[List[str]] = ["brokers", "topic", "balancer", "compression", "isTlsEnabled", "isInsecure", "auth", "principal", "realm", "service", "krb5", "keytab"]
