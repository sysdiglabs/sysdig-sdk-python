...
class CreatePricingRequestV1(BaseModel):
    """
    ...
    name: Annotated[str, Field(strict=True, max_length=256)] = Field(description="The name of the pricing configuration.")
    ...
    __properties: ClassVar[List[str]] = ["type", "clusterName", "name", "unitPricing", "spotLabel", "spotLabelValue"]
