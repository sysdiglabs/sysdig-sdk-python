...
class Fileaccess(BaseModel):
    ...
    tty: Optional[Annotated[int, Field(le=9223372036854775616, strict=True, ge=0)]] = Field(default=None, description="TTY number.")
    ...
    __properties: ClassVar[List[str]] = ["id", "timestamp", "type", "hostname", "containerId", "comm", "pid", "directory", "filename", "permissions", "tty", "labels"]
