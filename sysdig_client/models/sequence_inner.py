...
class SequenceInner(BaseModel):
    ...
    event_id: Annotated[str, Field(strict=True, max_length=36)] = Field(
        description="The unique identifier of the log event.", alias="eventId"
    )
    ...
    ingestion_id: Annotated[str, Field(strict=True, max_length=32)] = Field(
        description="The unique identifier of the ingestion.", alias="ingestionId"
    )
    ...
    source_ip_address: Annotated[str, Field(strict=True, max_length=64)] = Field(
        description="The IP address of the source.", alias="sourceIpAddress"
    )
    sub_ingestion_id: Annotated[str, Field(strict=True, max_length=32)] = Field(
        description="The unique identifier of the sub ingestion.", alias="subIngestionId"
    )
