...
RISKACCEPTEDRESPONSEALLOFCONTEXT_ONE_OF_SCHEMAS = [
    "List[HostNameContains]",
    "List[HostName]",
    "List[ImageNameContains]",
    "List[ImageName]",
    "List[ImagePrefix]",
    "List[ImageSuffix]",
    "List[PackageNameVersion]",
    "List[PackageName]",
    "List[PackagePathVersion]",
    "List[PackagePath]",
    "List[PackageVersion]",
    "List[object]",
]
...
class RiskAcceptedResponseAllOfContext(BaseModel):
    ...
    oneof_schema_1_validator: Optional[Annotated[List[Dict[str, Any]], Field(max_length=0)]] = Field(
        default=None, description="To be used when `entityType` is not `vulnerability` or `policyRule`."
    )
    # data type: List[ImageName]
    oneof_schema_2_validator: Optional[Annotated[List[ImageName], Field(min_length=1, max_length=1)]] = Field(
        default=None, description="Context to apply"
    )
    # data type: List[ImageSuffix]
    oneof_schema_3_validator: Optional[Annotated[List[ImageSuffix], Field(min_length=1, max_length=1)]] = Field(
        default=None, description="Context to apply"
    )
    # data type: List[ImagePrefix]
    oneof_schema_4_validator: Optional[Annotated[List[ImagePrefix], Field(min_length=1, max_length=1)]] = Field(
        default=None, description="Context to apply"
    )
    # data type: List[ImageNameContains]
    oneof_schema_5_validator: Optional[Annotated[List[ImageNameContains], Field(min_length=1, max_length=1)]] = Field(
        default=None, description="Context to apply"
    )
    # data type: List[PackageName]
    oneof_schema_6_validator: Optional[Annotated[List[PackageName], Field(min_length=1, max_length=1)]] = Field(
        default=None, description="Context to apply"
    )
    # data type: List[PackageNameVersion]
    oneof_schema_7_validator: Optional[Annotated[List[PackageNameVersion], Field(min_length=2, max_length=2)]] = Field(
        default=None, description="Context to apply"
    )
    # data type: List[HostName]
    oneof_schema_8_validator: Optional[Annotated[List[HostName], Field(min_length=1, max_length=1)]] = Field(
        default=None, description="Context host name"
    )
    # data type: List[HostNameContains]
    oneof_schema_9_validator: Optional[Annotated[List[HostNameContains], Field(min_length=1, max_length=1)]] = Field(
        default=None, description="Context to apply"
    )
    # data type: List[PackagePath]
    oneof_schema_10_validator: Optional[Annotated[List[PackagePath], Field(min_length=1, max_length=1)]] = Field(
        default=None, description="Context to apply"
    )
    # data type: List[PackageVersion]
    oneof_schema_11_validator: Optional[Annotated[List[PackageVersion], Field(min_length=1, max_length=1)]] = Field(
        default=None, description="Context to apply"
    )
    # data type: List[PackagePathVersion]
    oneof_schema_12_validator: Optional[Annotated[List[PackagePathVersion], Field(min_length=2, max_length=2)]] = Field(
        default=None, description="Context to apply"
    )
    ...
    def actual_instance_must_validate_oneof(cls, v):
        instance = RiskAcceptedResponseAllOfContext.model_construct()
        error_messages = []
        match = 0
        ...
        if match > 1:
            # more than 1 match
            raise ValueError(
                "Multiple matches found when setting `actual_instance` in RiskAcceptedResponseAllOfContext with oneOf schemas: List[HostNameContains], List[HostName], List[ImageNameContains], List[ImageName], List[ImagePrefix], List[ImageSuffix], List[PackageNameVersion], List[PackageName], List[PackagePathVersion], List[PackagePath], List[PackageVersion], List[object]. Details: "
                + ", ".join(error_messages)
            )
        elif match == 0:
            # no match
            raise ValueError(
                "No match found when setting `actual_instance` in RiskAcceptedResponseAllOfContext with oneOf schemas: List[HostNameContains], List[HostName], List[ImageNameContains], List[ImageName], List[ImagePrefix], List[ImageSuffix], List[PackageNameVersion], List[PackageName], List[PackagePathVersion], List[PackagePath], List[PackageVersion], List[object]. Details: "
                + ", ".join(error_messages)
            )
        else:
            return v
