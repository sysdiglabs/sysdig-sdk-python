...
class TestOpenIdUpdateRequestV1(unittest.TestCase):
    """OpenIdUpdateRequestV1 unit test stubs"""
    ...
    def make_instance(self, include_optional) -> OpenIdUpdateRequestV1:
        """Test OpenIdUpdateRequestV1
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `OpenIdUpdateRequestV1`
        """
        model = OpenIdUpdateRequestV1()
        if include_optional:
            return OpenIdUpdateRequestV1(
    ...
    def testOpenIdUpdateRequestV1(self):
        """Test OpenIdUpdateRequestV1"""
