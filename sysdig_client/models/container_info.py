...
class ContainerInfo(BaseModel):
    ...
    container_name: Annotated[str, Field(strict=True, max_length=253)] = Field(
        description="Container name.", alias="containerName"
    )
    pull_string: Optional[Annotated[str, Field(strict=True, max_length=1024)]] = Field(
        default=None, description="Pull string for image used for the container.", alias="pullString"
    )
