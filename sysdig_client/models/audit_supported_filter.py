...
class AuditSupportedFilter(BaseModel):
    ...
    operands: Optional[Annotated[List[Operand], Field(min_length=0, max_length=8)]] = Field(
        default=None, description="The list of supported operands for filtering events."
    )
