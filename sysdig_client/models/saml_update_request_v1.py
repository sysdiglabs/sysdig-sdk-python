...
class SamlUpdateRequestV1(SsoSettingsUpdateRequestBaseV1):
    ...
    email_parameter: Annotated[str, Field(strict=True, max_length=2048)] = Field(description="The email parameter of the SAML provider.", alias="emailParameter")
    is_signature_validation_enabled: StrictBool = Field(description="Flag that indicates if the signature validation is enabled.", alias="isSignatureValidationEnabled")
    is_signed_assertion_enabled: StrictBool = Field(description="Flag that indicates if the signed assertion is enabled.", alias="isSignedAssertionEnabled")
    is_destination_verification_enabled: StrictBool = Field(description="Flag that indicates if the destination verification is enabled.", alias="isDestinationVerificationEnabled")
    is_encryption_support_enabled: StrictBool = Field(description="Flag that indicates if the encryption support is enabled.", alias="isEncryptionSupportEnabled")
