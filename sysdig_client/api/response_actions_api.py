...
class ResponseActionsApi:
    ...
    def _get_action_execution_file_acquire_v1_serialize(
        ...
        if "Accept" not in _header_params:
            _header_params["Accept"] = self.api_client.select_header_accept(["application/octet-stream", "application/json"])
    ...
    def get_actions_v1(
        ...
        _param = self._get_actions_v1_serialize(
            context=context, _request_auth=_request_auth, _content_type=_content_type, _headers=_headers, _host_index=_host_index
        )
    ...
    def submit_action_executionv1(
        self,
        submit_action_execution_request: Annotated[
            SubmitActionExecutionRequest, Field(description="Configuration for the new integration")
        ],
        _request_timeout: Union[
            None,
            Annotated[StrictFloat, Field(gt=0)],
