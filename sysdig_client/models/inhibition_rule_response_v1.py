...
class InhibitionRuleResponseV1(BaseModel):
    ...
    customer_id: Optional[Annotated[int, Field(le=2147483647, strict=True, ge=0)]] = Field(default=None, description="ID of customer that owns the inhibition rule.", alias="customerId")
    team_id: Optional[Annotated[int, Field(le=2147483647, strict=True, ge=0)]] = Field(default=None, description="ID of team that owns the inhibition rule.", alias="teamId")
    ...
    name: Optional[Annotated[str, Field(strict=True, max_length=255)]] = Field(default=None, description="Name of the inhibition rule.")
    ...
    source_matchers: Optional[Annotated[List[LabelMatcherV1], Field(min_length=1, max_length=100)]] = Field(default=None, description="List of source matchers for which one or more alerts have to exist for the inhibition to take effect.", alias="sourceMatchers")
    target_matchers: Optional[Annotated[List[LabelMatcherV1], Field(min_length=1, max_length=100)]] = Field(default=None, description="List of target matchers that have to be fulfilled by the target alerts to be muted.", alias="targetMatchers")
    ...
    __properties: ClassVar[List[str]] = ["id", "version", "createdOn", "modifiedOn", "customerId", "teamId", "isEnabled", "name", "description", "sourceMatchers", "targetMatchers", "equal"]
