...
class Rule(BaseModel):
    ...
    rule_id: Optional[Annotated[str, Field(strict=True, max_length=255)]] = Field(
        default=None, description="rule's id", alias="ruleId"
    )
    rule_type: Annotated[str, Field(strict=True, max_length=255)] = Field(description="rule type", alias="ruleType")
    evaluation_result: Optional[StrictStr] = Field(
        default=None, description="result of rule evaluation", alias="evaluationResult"
    )
    predicates: Optional[Annotated[List[Predicate], Field(min_length=0, max_length=2147483647)]] = Field(
        default=None, description="list of rule's predicates"
    )
    ...
    failures: Optional[Annotated[List[RuleFailuresInner], Field(min_length=0, max_length=2147483647)]] = Field(
        default=None, description="list of rule failures"
    )
        ...
        _obj = cls.model_validate(
            {
                ...
                "predicates": [Predicate.from_dict(_item) for _item in obj["predicates"]]
                if obj.get("predicates") is not None
                else None,
                "failureType": obj.get("failureType"),
                "description": obj.get("description"),
                "failures": [RuleFailuresInner.from_dict(_item) for _item in obj["failures"]]
                if obj.get("failures") is not None
                else None,
            }
        )
        return _obj
