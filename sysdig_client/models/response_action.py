...
class ResponseAction(BaseModel):
    ...
    parameters: Annotated[List[ActionParameterMetadata], Field(max_length=100)] = Field(
        description="the list of parameters that the action supports"
    )
        ...
        _obj = cls.model_validate(
            {
                ...
                "parameters": [ActionParameterMetadata.from_dict(_item) for _item in obj["parameters"]]
                if obj.get("parameters") is not None
                else None,
                "outputs": [ActionOutputsMetadata.from_dict(_item) for _item in obj["outputs"]]
                if obj.get("outputs") is not None
                else None,
                "description": obj.get("description"),
                "isUndoable": obj.get("isUndoable"),
            }
        )
        return _obj
