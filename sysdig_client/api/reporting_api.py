...
class ReportingApi:
    ...
    def list_jobs_v1(
        ...
        report_id: Annotated[
            Optional[Annotated[int, Field(le=1000000, strict=True, ge=0)]], Field(description="ID of the Report")
        ] = None,
        is_report_template: Annotated[
            Optional[StrictStr], Field(description="Indicates whether the report is a template.")
        ] = None,
        completed_on: Annotated[
            Optional[Annotated[int, Field(strict=True, ge=0)]],
            Field(description="Date the job was completed in epoch milliseconds."),
        ] = None,
        ...
        policies: Annotated[
            ...
            Field(description="List of policy IDs in string format."),
        ] = None,
        zones: Annotated[
            Optional[Annotated[str, Field(strict=True, max_length=8192)]], Field(description="List of zone IDs in string format.")
        ] = None,
