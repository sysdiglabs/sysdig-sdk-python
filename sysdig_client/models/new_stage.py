...
class NewStage(BaseModel):
    ...
    configuration: Optional[Annotated[List[StageConfiguration], Field(min_length=0, max_length=1000)]] = Field(
        default=None, description="Configurations for the stage"
    )
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate(
            {
                "name": obj.get("name"),
                "configuration": [StageConfiguration.from_dict(_item) for _item in obj["configuration"]]
