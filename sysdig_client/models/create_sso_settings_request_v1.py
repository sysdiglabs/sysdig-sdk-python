...
class CreateSsoSettingsRequestV1(BaseModel):
    """
    ...
    config: SsoSettingsCreateRequestBaseV1
        ...
        _obj = cls.model_validate(
            {
                ...
                "config": SsoSettingsCreateRequestBaseV1.from_dict(obj["config"]) if obj.get("config") is not None else None,
            }
        )
        return _obj
