...
class ImageConfigDefaultUserIsRoot(BaseModel):
    """
    ...
    def type_validate_enum(cls, value):
        """Validates the enum"""
        if value not in set(['imageConfigDefaultUserIsRoot']):
            raise ValueError("must be one of enum values ('imageConfigDefaultUserIsRoot')")
        return value
