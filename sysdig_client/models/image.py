...
class Image(BaseModel):
    ...
    pull_string: Annotated[str, Field(strict=True, max_length=8192)] = Field(
        description="The pull string for the image.", alias="pullString"
    )
    ...
    vm_api_endpoint: Annotated[str, Field(strict=True, max_length=512)] = Field(
