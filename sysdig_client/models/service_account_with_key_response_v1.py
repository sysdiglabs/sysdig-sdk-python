...
class ServiceAccountWithKeyResponseV1(BaseModel):
    ...
    api_key: Optional[Annotated[str, Field(strict=True, max_length=256)]] = Field(default=None, description="Service Account API key", alias="apiKey")
    __properties: ClassVar[List[str]] = ["id", "name", "dateCreated", "lastUpdated", "lastUsed", "expirationDate", "teamId", "teamRole", "systemRoles", "apiKey"]
