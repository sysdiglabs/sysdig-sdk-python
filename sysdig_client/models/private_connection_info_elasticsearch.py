...
class PrivateConnectionInfoElasticsearch(BaseModel):
    """
    ...
    __properties: ClassVar[List[str]] = ["auth", "secret"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({"auth": obj.get("auth"), "secret": obj.get("secret")})
        return _obj
