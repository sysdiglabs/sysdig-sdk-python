...
class RegistryResultsResponse(BaseModel):
    """
    registry results response
    """ # noqa: E501
    page: Optional[VulnerabilityManagementPage] = None
    data: Optional[Annotated[List[RegistryResult], Field(min_length=0, max_length=1000)]] = None
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "data": [RegistryResult.from_dict(_item) for _item in obj["data"]] if obj.get("data") is not None else None
        })
        return _obj
