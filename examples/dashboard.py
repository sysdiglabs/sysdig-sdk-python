...
metrics = [{"id": "proc.name"}, {"id": "cpu.used.percent", "aggregations": {"time": "avg", "group": "avg"}}]
...
panel_type = "top"
metrics = [{"id": "host.hostName"}, {"id": "cpu.used.percent", "aggregations": {"time": "avg", "group": "avg"}}]
sort_direction = "desc"
limit = 10
layout = {"col": 1, "row": 7, "size_x": 12, "size_y": 6}
ok, res = sdclient.add_dashboard_panel(
    dashboard_configuration, panel_name, panel_type, metrics, sort_direction=sort_direction, limit=limit, layout=layout
)
...
panel_name = "CPU"
panel_type = "number"
metrics = [{"id": "cpu.used.percent", "aggregations": {"time": "avg", "group": "avg"}}]
