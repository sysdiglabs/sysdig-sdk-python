...
class Command(BaseModel):
    ...
    container_id: Optional[Annotated[str, Field(strict=True, max_length=200)]] = Field(
        default=None,
    ...
    login_shell_id: Annotated[int, Field(le=9223372036854775616, strict=True, ge=0)] = Field(
        description="Process id of the shell.", alias="loginShellId"
    )
    login_shell_distance: Annotated[int, Field(le=9223372036854775616, strict=True, ge=0)] = Field(
        description="Level of nesting from the parent shell.", alias="loginShellDistance"
    )
    ...
    user_login_uid: Annotated[int, Field(le=9223372036854775616, strict=True, ge=0)] = Field(
        description="User login UID.", alias="userLoginUid"
    )
    user_login_name: Annotated[str, Field(strict=True, max_length=20)] = Field(
        description="User login name.", alias="userLoginName"
    )
    proc_exepath: Annotated[str, Field(strict=True, max_length=4096)] = Field(
        description="Process executable path.", alias="procExepath"
    )
