...
class RuntimeResult(BaseModel):
    ...
    resource_id: Optional[Annotated[str, Field(strict=True, max_length=255)]] = Field(
        default=None,
        description="Identifier of the scanned resource: it will be the image ID for container images or the host ID for hosts.",
        alias="resourceId",
    )
    sbom_id: Optional[Annotated[str, Field(strict=True, max_length=255)]] = Field(
        default=None, description="Identifier of the sbom", alias="sbomId"
    )
    main_asset_name: Optional[Annotated[str, Field(strict=True, max_length=255)]] = Field(
        default=None, description="Name of the scanned asset", alias="mainAssetName"
    )
    ...
    is_risk_spotlight_enabled: Optional[StrictBool] = Field(
        default=None, description="Whether risk spotlight is enabled or not", alias="isRiskSpotlightEnabled"
    )
        ...
        _obj = cls.model_validate(
            {
                ...
                "runningVulnTotalBySeverity": VulnTotalBySeverity.from_dict(obj["runningVulnTotalBySeverity"])
                if obj.get("runningVulnTotalBySeverity") is not None
                else None,
