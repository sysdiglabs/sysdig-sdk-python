...
class CisaKevKnownRansomwareCampaignUse(BaseModel):
    """
    ...
    def type_validate_enum(cls, value):
        """Validates the enum"""
        if value not in set(['cisaKevKnownRansomwareCampaignUse']):
            raise ValueError("must be one of enum values ('cisaKevKnownRansomwareCampaignUse')")
        return value
