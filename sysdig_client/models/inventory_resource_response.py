...
class InventoryResourceResponse(BaseModel):
    ...
    """ # noqa: E501
    data: Annotated[List[InventoryResource], Field(max_length=10000)] = Field(description="The resources that matches the filter")
    page: InventoryPage
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "data": [InventoryResource.from_dict(_item) for _item in obj["data"]] if obj.get("data") is not None else None,
            "page": InventoryPage.from_dict(obj["page"]) if obj.get("page") is not None else None
        })
        return _obj
