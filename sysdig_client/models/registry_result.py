...
class RegistryResult(BaseModel):
    ...
    vendor: Optional[Annotated[str, Field(strict=True, max_length=255)]] = Field(default=None, description="Identifier the vendor of the image")
    pull_string: Optional[Annotated[str, Field(strict=True, max_length=2048)]] = Field(default=None, description="Name of the scanned asset", alias="pullString")
