...
class Package(BaseModel):
    ...
    Package
    """ # noqa: E501
    type: Annotated[str, Field(strict=True, max_length=255)] = Field(description="scan result package type, example values are:   - os   - rust   - java   - ruby   - javascript   - python   - php   - golang   - C#")
    name: Annotated[str, Field(strict=True, max_length=255)] = Field(description="name of the package")
    is_running: Optional[StrictBool] = Field(default=None, description="whether the package is used by a running process", alias="isRunning")
    ...
    license: Optional[Annotated[str, Field(strict=True, max_length=255)]] = Field(default=None, description="license of the package")
