...
class SamlCreateRequestV1(SsoSettingsCreateRequestBaseV1):
    """
    SamlCreateRequestV1
    """  # noqa: E501
    ...
    is_signature_validation_enabled: Optional[StrictBool] = Field(
        default=True,
        description="Flag that indicates if the signature validation is enabled.",
        alias="isSignatureValidationEnabled",
    )
    is_signed_assertion_enabled: Optional[StrictBool] = Field(
        default=True, description="Flag that indicates if the signed assertion is enabled.", alias="isSignedAssertionEnabled"
    )
    is_destination_verification_enabled: Optional[StrictBool] = Field(
        default=None,
        description="Flag that indicates if the destination verification is enabled.",
        alias="isDestinationVerificationEnabled",
    )
    is_encryption_support_enabled: Optional[StrictBool] = Field(
        default=None, description="Flag that indicates if the encryption support is enabled.", alias="isEncryptionSupportEnabled"
    )
