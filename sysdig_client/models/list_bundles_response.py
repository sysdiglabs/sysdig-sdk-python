...
class ListBundlesResponse(BaseModel):
    ...
    """ # noqa: E501
    page: PoliciesPage
    data: Annotated[List[GetBundleResponse], Field(min_length=0, max_length=1024)] = Field(description="Bundles collection")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "page": PoliciesPage.from_dict(obj["page"]) if obj.get("page") is not None else None,
            "data": [GetBundleResponse.from_dict(_item) for _item in obj["data"]] if obj.get("data") is not None else None
        })
        return _obj
