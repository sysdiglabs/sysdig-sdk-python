...
class ImageConfigSensitiveInformationAndSecrets(BaseModel):
    """
    ...
    def type_validate_enum(cls, value):
        """Validates the enum"""
        if value not in set(['imageConfigSensitiveInformationAndSecrets']):
            raise ValueError("must be one of enum values ('imageConfigSensitiveInformationAndSecrets')")
        return value
