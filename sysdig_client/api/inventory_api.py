...
class InventoryApi:
    ...
    def get_resource(
        ...
        _param = self._get_resource_serialize(
            hash=hash, _request_auth=_request_auth, _content_type=_content_type, _headers=_headers, _host_index=_host_index
        )
