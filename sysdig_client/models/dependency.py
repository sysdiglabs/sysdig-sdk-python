...
class Dependency(BaseModel):
    ...
    ref: Annotated[str, Field(strict=True, max_length=512)] = Field(
        description="References a component or service by its bom-ref attribute"
    )
    depends_on: Optional[Annotated[List[Annotated[str, Field(strict=True, max_length=512)]], Field(max_length=1000000)]] = Field(
        default=None,
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({"ref": obj.get("ref"), "dependsOn": obj.get("dependsOn")})
        return _obj
