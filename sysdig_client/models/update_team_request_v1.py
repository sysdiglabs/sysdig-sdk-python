...
class UpdateTeamRequestV1(BaseModel):
    ...
    is_default_team: StrictBool = Field(description="Specifies if this is the default team. The default team is used to automatically assign new users to a team.", alias="isDefaultTeam")
    standard_team_role: Optional[TeamRoleV1] = Field(default=None, description="The standard team role assigned by default to users added to this team. ", alias="standardTeamRole")
    custom_team_role_id: Optional[Annotated[int, Field(strict=True, ge=0)]] = Field(default=None, description="The custom team role assigned by default to users added to this team. ", alias="customTeamRoleId")
    ...
    scopes: Annotated[List[ScopeV1], Field(min_length=1, max_length=512)] = Field(description="Scopes is a list of different scope types and filter values that will be applied to resources when accessed through the team. ")
