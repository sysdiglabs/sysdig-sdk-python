...
class BucketConfigurationV1(BaseModel):
    ...
    folder: Optional[Annotated[str, Field(strict=True, max_length=255)]] = Field(
        default=None,
    ...
    description: Optional[Annotated[str, Field(strict=True, max_length=255)]] = Field(
        default=None, description="The description of the bucket."
    )
    provider_key_id: Optional[Annotated[str, Field(strict=True, max_length=255)]] = Field(
        default=None,
        description="Id of the configured cloud provider account. Could be fetched with /api/providers endpoint.",
        alias="providerKeyId",
    )
    endpoint: Optional[Annotated[str, Field(strict=True, max_length=255)]] = Field(
        default=None, description="The endpoint of the bucket. ***Required for S3 compatible storage.***"
    )
    region: Optional[Annotated[str, Field(strict=True, max_length=255)]] = Field(
        default=None, description="The region of the bucket."
    )
    path_style_access: Optional[StrictBool] = Field(
        default=False, description="Specifies if the bucket uses path-style access.", alias="pathStyleAccess"
    )
