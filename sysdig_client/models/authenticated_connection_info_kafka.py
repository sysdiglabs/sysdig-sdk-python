...
class AuthenticatedConnectionInfoKafka(BaseModel):
    """
    ...
    keytab: Annotated[str, Field(strict=True, max_length=1048576)] = Field(description="base64 encoded Kerberos keytab")
