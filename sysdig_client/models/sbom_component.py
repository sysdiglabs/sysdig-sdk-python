...
class SbomComponent(BaseModel):
    ...
    bom_ref: Optional[Annotated[str, Field(strict=True, max_length=512)]] = Field(
        default=None,
    ...
    version: Optional[Annotated[str, Field(strict=True, max_length=512)]] = Field(
        default=None,
        description="The component version. The version should ideally comply with semantic versioning but is not enforced.",
    )
    group: Optional[Annotated[str, Field(strict=True, max_length=512)]] = Field(
        default=None,
    ...
    purl: Optional[Annotated[str, Field(strict=True, max_length=512)]] = Field(
        default=None,
