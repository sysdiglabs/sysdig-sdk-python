...
class GetCustomJobsPaginatedResponseV1(BaseModel):
    """
    GetCustomJobsPaginatedResponseV1
    """  # noqa: E501

    page: Optional[OffsetPaginatedResponsePage] = None
    data: Optional[Annotated[List[CustomJobV1], Field(max_length=200)]] = None
        ...
        _obj = cls.model_validate(
            {
                ...
                "data": [CustomJobV1.from_dict(_item) for _item in obj["data"]] if obj.get("data") is not None else None,
            }
        )
        return _obj
