...
class PolicyClientV2(_SdcCommon):
    ...
    def add_policy(
        ...
        res = self.http.post(self.url + "/api/v2/policies", headers=self.hdrs, data=json.dumps(policy), verify=self.ssl_verify)
        return self._request_result(res)
    ...
    def add_policy_json(self, policy_json):
        ...
        res = self.http.post(
            self.url + "/api/v2/policies", headers=self.hdrs, data=json.dumps(policy_obj), verify=self.ssl_verify
        )
        return self._request_result(res)
    ...
    def update_policy(
        ...
        res = self.http.put(
            self.url + "/api/v2/policies/{}".format(id), headers=self.hdrs, data=json.dumps(policy), verify=self.ssl_verify
        )
        return self._request_result(res)
