...
class ListZonesResponseV1AllOfData(BaseModel):
    """
    ...
    description: Optional[Annotated[str, Field(strict=True, max_length=8192)]] = Field(
        default=None, description="The description of the Zone"
    )
    author: Optional[Annotated[str, Field(strict=True, max_length=512)]] = Field(
        default=None, description="Email of the user who created this Zone"
    )
    last_modified_by: Optional[Annotated[str, Field(strict=True, max_length=512)]] = Field(
        default=None, description="Email of the user who last modified the Zone", alias="lastModifiedBy"
    )
    last_updated: Optional[Annotated[int, Field(strict=True, ge=0)]] = Field(
        default=None,
        description="Timestamp indicating the moment the Zone has been last updated.\\ It is expressed in milliseconds elapsed since January 1, 1970 UTC. ",
        alias="lastUpdated",
    )
    is_system: Optional[StrictBool] = Field(
        default=None, description="Boolean value indicating if the Zone is a *System* one", alias="isSystem"
    )
