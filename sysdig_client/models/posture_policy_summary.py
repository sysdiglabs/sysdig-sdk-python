...
class PosturePolicySummary(BaseModel):
    ...
    pass_percentage: Annotated[int, Field(le=100, strict=True, ge=0)] = Field(
        description="Percentage of policies passing", alias="passPercentage"
    )
        ...
        _obj = cls.model_validate(
            {
                ...
                "policies": [PoliciesSummaryEntry.from_dict(_item) for _item in obj["policies"]]
