...
class EntriesResponse(BaseModel):
    ...
    data: Optional[Annotated[List[EntriesResponseDataInner], Field(max_length=200)]] = Field(default=None, description="The actual data contained in one of the supported types of entry")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "data": [EntriesResponseDataInner.from_dict(_item) for _item in obj["data"]] if obj.get("data") is not None else None
        })
        return _obj
