...
class CreateNotificationChannelRequestV1(BaseModel):
    ...
    __discriminator_value_class_map: ClassVar[Dict[str, str]] = {
        "CUSTOM_WEBHOOK": "CreateCustomWebhookNotificationChannelRequestV1",
        "EMAIL": "CreateEmailNotificationChannelRequestV1",
        "GCHAT": "CreateGchatNotificationChannelRequestV1",
        "IBM_EVENT_NOTIFICATIONS": "CreateIbmEventNotificationsNotificationChannelRequestV1",
        "MS_TEAMS": "CreateMsTeamsNotificationChannelRequestV1",
        "OPSGENIE": "CreateOpsgenieNotificationChannelRequestV1",
        "PAGER_DUTY": "CreatePagerDutyNotificationChannelRequestV1",
        "PROMETHEUS_ALERT_MANAGER": "CreatePrometheusAlertManagerNotificationChannelRequestV1",
        "SLACK": "CreateSlackNotificationChannelRequestV1",
        "SNS": "CreateSnsNotificationChannelRequestV1",
        "TEAM_EMAIL": "CreateTeamEmailNotificationChannelRequestV1",
        "VICTOROPS": "CreateVictorOpsNotificationChannelRequestV1",
        "WEBHOOK": "CreateWebhookNotificationChannelRequestV1",
    }
    ...
    def from_dict(
        ...
        if object_type == "CreateCustomWebhookNotificationChannelRequestV1":
            return import_module(
                "sysdig_client.models.create_custom_webhook_notification_channel_request_v1"
            ).CreateCustomWebhookNotificationChannelRequestV1.from_dict(obj)
        if object_type == "CreateEmailNotificationChannelRequestV1":
            return import_module(
                "sysdig_client.models.create_email_notification_channel_request_v1"
            ).CreateEmailNotificationChannelRequestV1.from_dict(obj)
        if object_type == "CreateGchatNotificationChannelRequestV1":
            return import_module(
                "sysdig_client.models.create_gchat_notification_channel_request_v1"
            ).CreateGchatNotificationChannelRequestV1.from_dict(obj)
        if object_type == "CreateIbmEventNotificationsNotificationChannelRequestV1":
            return import_module(
                "sysdig_client.models.create_ibm_event_notifications_notification_channel_request_v1"
            ).CreateIbmEventNotificationsNotificationChannelRequestV1.from_dict(obj)
        if object_type == "CreateMsTeamsNotificationChannelRequestV1":
            return import_module(
                "sysdig_client.models.create_ms_teams_notification_channel_request_v1"
            ).CreateMsTeamsNotificationChannelRequestV1.from_dict(obj)
        if object_type == "CreateOpsgenieNotificationChannelRequestV1":
            return import_module(
                "sysdig_client.models.create_opsgenie_notification_channel_request_v1"
            ).CreateOpsgenieNotificationChannelRequestV1.from_dict(obj)
        if object_type == "CreatePagerDutyNotificationChannelRequestV1":
            return import_module(
                "sysdig_client.models.create_pager_duty_notification_channel_request_v1"
            ).CreatePagerDutyNotificationChannelRequestV1.from_dict(obj)
        if object_type == "CreatePrometheusAlertManagerNotificationChannelRequestV1":
            return import_module(
                "sysdig_client.models.create_prometheus_alert_manager_notification_channel_request_v1"
            ).CreatePrometheusAlertManagerNotificationChannelRequestV1.from_dict(obj)
        if object_type == "CreateSlackNotificationChannelRequestV1":
            return import_module(
                "sysdig_client.models.create_slack_notification_channel_request_v1"
            ).CreateSlackNotificationChannelRequestV1.from_dict(obj)
        if object_type == "CreateSnsNotificationChannelRequestV1":
            return import_module(
                "sysdig_client.models.create_sns_notification_channel_request_v1"
            ).CreateSnsNotificationChannelRequestV1.from_dict(obj)
        if object_type == "CreateTeamEmailNotificationChannelRequestV1":
            ...
            ).CreateTeamEmailNotificationChannelRequestV1.from_dict(obj)
        if object_type == "CreateVictorOpsNotificationChannelRequestV1":
            return import_module(
                "sysdig_client.models.create_victor_ops_notification_channel_request_v1"
            ).CreateVictorOpsNotificationChannelRequestV1.from_dict(obj)
        if object_type == "CreateWebhookNotificationChannelRequestV1":
            return import_module(
                "sysdig_client.models.create_webhook_notification_channel_request_v1"
            ).CreateWebhookNotificationChannelRequestV1.from_dict(obj)

        raise ValueError(
            "CreateNotificationChannelRequestV1 failed to lookup discriminator value from "
            + json.dumps(obj)
