...
class GetBundleResponse(BaseModel):
    ...
    identifier: Annotated[str, Field(min_length=1, strict=True, max_length=1024)] = Field(
        description="The Policy identifier generated from the name"
    )
    description: Optional[Annotated[str, Field(min_length=0, strict=True, max_length=4096)]] = Field(
        default=None, description="The Bundle description"
    )
    bundle_type: StrictStr = Field(
        description="Specifies whether the Bundle was defined by the Customer or by Sysdig", alias="bundleType"
    )
