...
class ImageConfigDefaultUserIsNot(BaseModel):
    """
    Predicate expressing \"the container user does not default to the specified user\". 
    """ # noqa: E501
    type: StrictStr
    extra: ImageConfigDefaultUserIsNotExtra
    ...
    def type_validate_enum(cls, value):
        ...
        if value not in set(['imageConfigDefaultUserIsNot']):
            raise ValueError("must be one of enum values ('imageConfigDefaultUserIsNot')")
        return value
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "type": obj.get("type"),
            "extra": ImageConfigDefaultUserIsNotExtra.from_dict(obj["extra"]) if obj.get("extra") is not None else None
        })
        return _obj
