...
class TestOpenIdBaseV1(unittest.TestCase):
    """OpenIdBaseV1 unit test stubs"""
    ...
    def make_instance(self, include_optional) -> OpenIdBaseV1:
        """Test OpenIdBaseV1
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `OpenIdBaseV1`
        """
        model = OpenIdBaseV1()
        if include_optional:
            return OpenIdBaseV1(
