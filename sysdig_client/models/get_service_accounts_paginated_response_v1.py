...
class GetServiceAccountsPaginatedResponseV1(BaseModel):
    """
    GetServiceAccountsPaginatedResponseV1
    """ # noqa: E501
    page: Optional[OffsetPaginatedResponsePage] = None
    data: Optional[Annotated[List[ServiceAccountResponseV1], Field(max_length=200)]] = None
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "data": [ServiceAccountResponseV1.from_dict(_item) for _item in obj["data"]] if obj.get("data") is not None else None
        })
        return _obj
