...
class ListEventsResponse(BaseModel):
    ...
    """ # noqa: E501
    page: EventsFeedPage
    data: Annotated[List[Event], Field(max_length=20000)] = Field(description="The list of events")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "page": EventsFeedPage.from_dict(obj["page"]) if obj.get("page") is not None else None,
