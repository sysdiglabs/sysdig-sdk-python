        ...
        _obj = cls.model_validate(
            {
                ...
                "packages": dict((_k, Package.from_dict(_v)) for _k, _v in obj["packages"].items())
                if obj.get("packages") is not None
                else None,
                "vulnerabilities": dict((_k, Vulnerability.from_dict(_v)) for _k, _v in obj["vulnerabilities"].items())
                if obj.get("vulnerabilities") is not None
                else None,
                "layers": dict((_k, Layer.from_dict(_v)) for _k, _v in obj["layers"].items())
                if obj.get("layers") is not None
                else None,
                "baseImages": dict((_k, BaseImage.from_dict(_v)) for _k, _v in obj["baseImages"].items())
                if obj.get("baseImages") is not None
                else None,
                "policies": Policies.from_dict(obj["policies"]) if obj.get("policies") is not None else None,
                "riskAccepts": dict((_k, RiskAcceptanceDefinition.from_dict(_v)) for _k, _v in obj["riskAccepts"].items())
