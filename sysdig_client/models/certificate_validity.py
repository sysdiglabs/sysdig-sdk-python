...
class CertificateValidity(BaseModel):
    ...
    """ # noqa: E501
    after: Optional[datetime] = Field(default=None, description="The beginning of the certificate validity period.")
    before: Optional[datetime] = Field(default=None, description="The end of the certificate validity period.")
