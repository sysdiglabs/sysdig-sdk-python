...
class ImageConfigInstructionIsPkgManager(BaseModel):
    """
    ...
    def type_validate_enum(cls, value):
        """Validates the enum"""
        if value not in set(['imageConfigInstructionIsPkgManager']):
            raise ValueError("must be one of enum values ('imageConfigInstructionIsPkgManager')")
        return value
