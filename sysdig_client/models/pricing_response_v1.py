...
class PricingResponseV1(BaseModel):
    """
    ...
    cluster_name: Optional[Annotated[str, Field(strict=True, max_length=256)]] = Field(
        default=None, description="The name of the cluster. Required when `type` is `CLUSTER`.", alias="clusterName"
    )
    name: Optional[Annotated[str, Field(strict=True, max_length=256)]] = Field(
        default=None, description="The name of the pricing profile."
    )
    unit_pricing: Optional[UnitPricingV1] = Field(
        default=None, description="The unit pricing configuration used to compute costs.", alias="unitPricing"
    )
    spot_label: Optional[Annotated[str, Field(strict=True, max_length=256)]] = Field(
        default=None, description="The name of a node label that is used to identify the node as a spot node.", alias="spotLabel"
    )
    spot_label_value: Optional[Annotated[str, Field(strict=True, max_length=256)]] = Field(
        default=None, description="The value of the spot node label.", alias="spotLabelValue"
    )
