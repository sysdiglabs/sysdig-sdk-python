...
_POLICY_ACTIONS = [
    {"type": "POLICY_ACTION_STOP", "msg": ""},
    {"type": "POLICY_ACTION_PAUSE", "msg": ""},
    {"type": "POLICY_ACTION_CAPTURE", "beforeEventNs": 5000000000, "afterEventNs": 18000000000, "isLimitedToContainer": True},
]
...
with description("Policies v1", "integration") as self:
    with before.all:
        self.clientV1 = SdSecureClientV1(
