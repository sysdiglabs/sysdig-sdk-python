...
class PolicyEvaluation(BaseModel):
    ...
    description: Optional[Annotated[str, Field(strict=True, max_length=1024)]] = Field(
        default=None, description="policy evaluation description"
    )
    ...
    updated_at: Annotated[str, Field(strict=True, max_length=255)] = Field(
        description="datetime of last update", alias="updatedAt"
    )
