...
class TestSplunkUpdateConnectionInfo(unittest.TestCase):
    """SplunkUpdateConnectionInfo unit test stubs"""
    ...
    def make_instance(self, include_optional) -> SplunkUpdateConnectionInfo:
        """Test SplunkUpdateConnectionInfo
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `SplunkUpdateConnectionInfo`
        """
        model = SplunkUpdateConnectionInfo()
        if include_optional:
            return SplunkUpdateConnectionInfo(
    ...
    def testSplunkUpdateConnectionInfo(self):
        """Test SplunkUpdateConnectionInfo"""
