...
class SdSecureClient(FalcoRulesFilesClientOld, PolicyEventsClientV1, PolicyEventsClientOld, PolicyClientV2, _SdcCommon):
    ...
    def get_rules_group(self, name):
        ...
        **Success Return Value**
            A JSON object representing the list of rules.
        """
        res = self.http.get(self.url + "/api/secure/rules/groups?name={}".format(name), headers=self.hdrs, verify=self.ssl_verify)
        return self._request_result(res)
    ...
    def add_rule(self, name, details={}, description="", tags=[]):
        ...
        **Success Return Value**
            A JSON object representing the rule.
        """
        rule = {"name": name, "description": description, "details": details, "tags": tags}
        res = self.http.post(self.url + "/api/secure/rules", data=json.dumps(rule), headers=self.hdrs, verify=self.ssl_verify)
        return self._request_result(res)
    ...
    def update_rule(self, id, details={}, description="", tags=[]):
        ...
        **Success Return Value**
        ...
        if tags:
            rule["tags"] = tags
        res = self.http.put(
            self.url + "/api/secure/rules/{}".format(id), data=json.dumps(rule), headers=self.hdrs, verify=self.ssl_verify
        )
        return self._request_result(res)
    ...
    def get_falco_macros_group(self, name):
        ...
        **Success Return Value**
        ...
        """
        res = self.http.get(
            self.url + "/api/secure/falco/macros/groups?name={}".format(name), headers=self.hdrs, verify=self.ssl_verify
        )
        return self._request_result(res)
    ...
    def get_falco_macro_id(self, id):
        ...
        **Success Return Value**
        ...
        """
        res = self.http.get(self.url + "/api/secure/falco/macros/{}".format(id), headers=self.hdrs, verify=self.ssl_verify)
        return self._request_result(res)
    ...
    def add_falco_macro(self, name, condition, append=False):
        ...
        **Success Return Value**
            A JSON object representing the falco macro.
        """
        macro = {"name": name, "condition": {"components": [], "condition": condition}, "append": append}
        res = self.http.post(
            self.url + "/api/secure/falco/macros", data=json.dumps(macro), headers=self.hdrs, verify=self.ssl_verify
        )
        return self._request_result(res)
    ...
    def update_falco_macro(self, id, condition):
        ...
        **Success Return Value**
        ...
        res = self.http.put(
            self.url + "/api/secure/falco/macros/{}".format(id), data=json.dumps(macro), headers=self.hdrs, verify=self.ssl_verify
        )
        return self._request_result(res)
    ...
    def delete_falco_macro(self, id):
        ...
        **Success Return Value**
            A JSON object representing the macro.
        """
        res = self.http.delete(self.url + "/api/secure/falco/macros/{}".format(id), headers=self.hdrs, verify=self.ssl_verify)
        return self._request_result(res)
    ...
    def get_falco_lists_group(self, name):
        ...
        **Success Return Value**
        ...
        """
        res = self.http.get(
            self.url + "/api/secure/falco/lists/groups?name={}".format(name), headers=self.hdrs, verify=self.ssl_verify
        )
        return self._request_result(res)
    ...
    def get_falco_list_id(self, id):
        ...
        **Success Return Value**
        ...
        """
        res = self.http.get(self.url + "/api/secure/falco/lists/{}".format(id), headers=self.hdrs, verify=self.ssl_verify)
        return self._request_result(res)
    ...
    def add_falco_list(self, name, items, append=False):
        ...
        **Success Return Value**
        ...
        res = self.http.post(
            self.url + "/api/secure/falco/lists", data=json.dumps(flist), headers=self.hdrs, verify=self.ssl_verify
        )
        return self._request_result(res)
    ...
    def update_falco_list(self, id, items):
        ...
        **Success Return Value**
        ...
        res = self.http.put(
            self.url + "/api/secure/falco/lists/{}".format(id), data=json.dumps(flist), headers=self.hdrs, verify=self.ssl_verify
        )
        return self._request_result(res)
    ...
    def delete_falco_list(self, id):
        ...
        **Success Return Value**
            A JSON object representing the list.
        """
        res = self.http.delete(self.url + "/api/secure/falco/lists/{}".format(id), headers=self.hdrs, verify=self.ssl_verify)
        return self._request_result(res)

    def add_compliance_task(
        self, name, module_name="docker-bench-security", schedule="06:00:00Z/PT12H", scope=None, enabled=True
    ):
        """**Description**
        ...
        **Success Return Value**
        ...
        """
        task = {"id": None, "name": name, "moduleName": module_name, "enabled": enabled, "scope": scope, "schedule": schedule}
        res = self.http.post(self.url + "/api/complianceTasks", data=json.dumps(task), headers=self.hdrs, verify=self.ssl_verify)
        return self._request_result(res)
    ...
    def update_compliance_task(self, id, name=None, module_name=None, schedule=None, scope=None, enabled=None):
        ...
        **Success Return Value**
        ...
        task = res
        options = {"name": name, "moduleName": module_name, "schedule": schedule, "scope": scope, "enabled": enabled}
        task.update({k: v for k, v in options.items() if v is not None})
        res = self.http.put(
            self.url + "/api/complianceTasks/{}".format(id), data=json.dumps(task), headers=self.hdrs, verify=self.ssl_verify
        )
        return self._request_result(res)
    ...
    def delete_compliance_task(self, id):
        ...
        **Arguments**
        ...
        """
        res = self.http.delete(self.url + "/api/complianceTasks/{}".format(id), headers=self.hdrs, verify=self.ssl_verify)
    ...
    def get_compliance_results_csv(self, id):
        ...
        **Success Return Value**
        ...
        """
        res = self.http.get(self.url + "/api/complianceResults/{}/csv".format(id), headers=self.hdrs, verify=self.ssl_verify)
        if not self._checkResponse(res):
            return False, self.lasterr
    ...
    def list_commands_audit(
        self, from_sec=None, to_sec=None, scope_filter=None, command_filter=None, limit=100, offset=0, metrics=[]
    ):
        """**Description**
    ...
    def get_command_audit(self, id, metrics=[]):
        ...
        **Success Return Value**
        ...
        url = "{url}/api/commands/{id}?from=0&to={to}{metrics}".format(
            url=self.url, id=id, to=int(time.time() * 10**6), metrics="&metrics=" + json.dumps(metrics) if metrics else ""
        )
        res = self.http.get(url, headers=self.hdrs, verify=self.ssl_verify)
        return self._request_result(res)
