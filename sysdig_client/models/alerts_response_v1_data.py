...
class AlertsResponseV1Data(BaseModel):
    """
    Response payload containing active alerts.
    """ # noqa: E501
    alerts: Optional[List[AlertsResponseV1DataAlertsInner]] = Field(default=None, description="List of currently active alerts.")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "alerts": [AlertsResponseV1DataAlertsInner.from_dict(_item) for _item in obj["alerts"]] if obj.get("alerts") is not None else None
        })
        return _obj
