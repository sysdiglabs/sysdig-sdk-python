...
class PricingResponseV1(BaseModel):
    ...
    name: Optional[Annotated[str, Field(strict=True, max_length=256)]] = Field(default=None, description="The name of the pricing profile.")
    unit_pricing: Optional[UnitPricingV1] = Field(default=None, description="The unit pricing configuration used to compute costs.", alias="unitPricing")
    ...
    __properties: ClassVar[List[str]] = ["id", "type", "clusterName", "name", "unitPricing", "spotLabel", "spotLabelValue", "version"]
