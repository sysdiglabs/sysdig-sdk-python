...
class CreateTeamRequestV1(BaseModel):
    ...
    description: Optional[Annotated[str, Field(strict=True, max_length=2048)]] = Field(
        default=None, description="A longer description of the team explaining what is it used for."
    )
    is_default_team: Optional[StrictBool] = Field(
        default=None,
    ...
    standard_team_role: Optional[TeamRoleV1] = Field(
        default=None,
        description="The standard team role assigned by default to users added to this team. **Mutually exclusive with customTeamRoleId**.\\ \\ *ROLE_TEAM_SERVICE_MANAGER is only supported in Secure.* ",
    ...
    scopes: Optional[Annotated[List[ScopeV1], Field(max_length=512)]] = Field(
        default=None,
