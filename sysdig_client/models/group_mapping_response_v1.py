...
class GroupMappingResponseV1(BaseModel):
    """
    GroupMappingResponseV1
    """ # noqa: E501
    id: Optional[Annotated[int, Field(strict=True, ge=0)]] = Field(default=None, description=" ")
    group_name: Optional[Annotated[str, Field(strict=True, max_length=256)]] = Field(default=None, description="The group name matching the external provider name.", alias="groupName")
    ...
    team_map: Optional[TeamMapV1] = Field(default=None, alias="teamMap")
    weight: Optional[Annotated[int, Field(le=32767, strict=True, ge=1)]] = Field(default=None, description="The weight of the group mapping that is used to determine the priority - a lower number has higher priority.")
    date_created: Optional[datetime] = Field(default=None, description="The date in which this group mapping was created in ISO 8601 format.", alias="dateCreated")
    last_updated: Optional[datetime] = Field(default=None, description="The date in which this group mapping was last updated in ISO 8601 format.", alias="lastUpdated")
    __properties: ClassVar[List[str]] = ["id", "groupName", "standardTeamRole", "customTeamRoleId", "isAdmin", "teamMap", "weight", "dateCreated", "lastUpdated"]
