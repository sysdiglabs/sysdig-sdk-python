    ...
    **Returns**
    ...
    def list_notification_channels(self):
        ...
        **Success Return Value**
        ...
        """
        res = self.http.get(
            self.url + "/api/notificationChannels",
            headers=self.hdrs,
            verify=self.ssl_verify,
        )
        return self._request_result(res)
    ...
    def get_notification_channel(self, id):
        res = self.http.get(
            self.url + "/api/notificationChannels/" + str(id),
            headers=self.hdrs,
            verify=self.ssl_verify,
        )
        if not self._checkResponse(res):
    ...
    def get_data_retention_info(self):
        ...
        **Example**
        ...
        """
        res = self.http.get(
            self.url + "/api/history/timelines/",
            headers=self.hdrs,
            verify=self.ssl_verify,
        )
        return self._request_result(res)
    ...
    def delete_sysdig_capture(self, capture_id):
        ...
        res = self.http.delete(
            f"{self.url}/api/sysdig/{capture_id}",
            headers=self.hdrs,
            verify=self.ssl_verify,
        )
    ...
    def create_user(self, user_email, first_name=None, last_name=None, password=None):
        ...
        res = self.http.post(
            self.url + "/api/user/provisioning/",
            headers=self.hdrs,
    ...
    def edit_user(self, user_email, firstName=None, lastName=None, systemRole=None):
        ...
        res = self.http.put(
            self.url + "/api/users/" + str(user["id"]),
            headers=self.hdrs,
    ...
    def get_team(self, name):
        ...
        **Example**
        ...
        """
        res = self.http.get(
            self.url + "/api/v2/teams/light/name/" + str(name),
            headers=self.hdrs,
            verify=self.ssl_verify,
        )
        if not self._checkResponse(res):
    ...
    def edit_team(
        ...
        **Example**
        ...
        res = self.http.put(
            self.url + "/api/teams/" + str(team["id"]),
            headers=self.hdrs,
            data=json.dumps(reqbody),
            verify=self.ssl_verify,
        )
    ...
    def list_memberships(self, team):
        ...
        **Example**
        ...
        if not ok:
            ...
            return [
                True,
                dict([(res[m["userId"]], m["role"]) for m in raw_memberships]),
            ]
    ...
    def list_access_keys(self):
        ...
        **Example**
        ...
        """
        res = self.http.get(
            self.url + "/api/customer/accessKeys",
            headers=self.hdrs,
            verify=self.ssl_verify,
        )
        return self._request_result(res)
    ...
    def disable_access_key(self, access_key):
        ...
        **Reslut**
        ...
        """
        res = self.http.post(
            self.url + "/api/customer/accessKeys/" + access_key + "/disable/",
            headers=self.hdrs,
            verify=self.ssl_verify,
        )
        return self._request_result(res)
    ...
    def enable_access_key(self, access_key):
        ...
        **Reslut**
        ...
        """
        res = self.http.post(
            self.url + "/api/customer/accessKeys/" + access_key + "/enable/",
            headers=self.hdrs,
            verify=self.ssl_verify,
        )
        return self._request_result(res)
    ...
    def get_user_api_token(self, username, teamname):
        ...
        res = self.http.get(
            self.url + "/api/token/%s/%d" % (username, team["id"]),
            headers=self.hdrs,
            verify=self.ssl_verify,
        )
        if not self._checkResponse(res):
