...
class DenyPkgExtra(BaseModel):
    """
    DenyPkgExtra
    """ # noqa: E501
    packages: Annotated[List[DenyPkgExtraPackagesInner], Field(min_length=1, max_length=1024)]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "packages": [DenyPkgExtraPackagesInner.from_dict(_item) for _item in obj["packages"]] if obj.get("packages") is not None else None
        })
        return _obj
