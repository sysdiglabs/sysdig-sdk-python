...
class WorkloadRightsizingDataRequest(BaseModel):
    ...
    algorithm: Annotated[str, Field(strict=True, max_length=64)] = Field(description="Aggregation algorithm used for rightsizing analysis. Currently supported values are: - AVG  - P95  - MAX This field is case-sensitive and may support more values in the future. ")
