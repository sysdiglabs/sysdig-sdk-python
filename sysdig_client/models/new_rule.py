...
class NewRule(BaseModel):
    ...
    predicates: Annotated[List[PredicatesInner], Field(min_length=1, max_length=1000)] = Field(
        description="The Predicates defining this Rule"
    )
    ...
    def rule_type_validate_enum(cls, value):
        ...
        if value not in set(
            ...
            raise ValueError(
                "must be one of enum values ('vulnSeverityAndThreats', 'vulnDenyList', 'imageConfigDefaultUser', 'imageConfigLabel', 'imageConfigEnvVariable', 'imageConfigInstructionNotRecommended', 'imageConfigInstructionIsPkgManager', 'imageConfigCreationDate', 'imageConfigSensitiveInformationAndSecrets', 'pkgDenyList')"
            )
        return value
        ...
        _obj = cls.model_validate(
            {
                ...
                "predicates": [PredicatesInner.from_dict(_item) for _item in obj["predicates"]]
