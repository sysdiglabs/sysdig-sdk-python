...
class TestOpenIdConfigResponseV1(unittest.TestCase):
    """OpenIdConfigResponseV1 unit test stubs"""
    ...
    def make_instance(self, include_optional) -> OpenIdConfigResponseV1:
        """Test OpenIdConfigResponseV1
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `OpenIdConfigResponseV1`
        """
        model = OpenIdConfigResponseV1()
        if include_optional:
            return OpenIdConfigResponseV1(
    ...
    def testOpenIdConfigResponseV1(self):
        """Test OpenIdConfigResponseV1"""
