...
class EntriesResponse(BaseModel):
    ...
    data: Optional[Annotated[List[EntriesResponseDataInner], Field(max_length=200)]] = Field(
        default=None, description="The actual data contained in one of the supported types of entry"
    )
        ...
        _obj = cls.model_validate(
            {
                ...
                "data": [EntriesResponseDataInner.from_dict(_item) for _item in obj["data"]]
