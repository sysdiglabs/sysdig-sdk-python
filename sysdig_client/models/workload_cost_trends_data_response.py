...
class WorkloadCostTrendsDataResponse(BaseModel):
    ...
    group_by_data: Optional[Annotated[List[WorkloadCostTrendsDataResponseGroupByDataInner], Field(max_length=10000)]] = Field(
        default=None, description="Grouped cost data for each combination of label values.", alias="groupByData"
    )
        ...
        _obj = cls.model_validate(
            {
                ...
                "groupByData": [WorkloadCostTrendsDataResponseGroupByDataInner.from_dict(_item) for _item in obj["groupByData"]]
