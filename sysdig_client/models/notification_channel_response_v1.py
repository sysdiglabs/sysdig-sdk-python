...
class NotificationChannelResponseV1(BaseModel):
    ...
    customer_id: Optional[Annotated[int, Field(le=2147483647, strict=True, ge=0)]] = Field(
        default=None, description="ID of customer that owns the notification channel.", alias="customerId"
    )
    ...
    __discriminator_value_class_map: ClassVar[Dict[str, str]] = {
        "CUSTOM_WEBHOOK": "CustomWebhookNotificationChannelResponseV1",
        "EMAIL": "EmailNotificationChannelResponseV1",
        "GCHAT": "GchatNotificationChannelResponseV1",
        "IBM_EVENT_NOTIFICATIONS": "IbmEventNotificationsNotificationChannelResponseV1",
        "MS_TEAMS": "MsTeamsNotificationChannelResponseV1",
        "OPSGENIE": "OpsgenieNotificationChannelResponseV1",
        "PAGER_DUTY": "PagerDutyNotificationChannelResponseV1",
        "PROMETHEUS_ALERT_MANAGER": "PrometheusAlertManagerNotificationChannelResponseV1",
        "SLACK": "SlackNotificationChannelResponseV1",
        "SNS": "SnsNotificationChannelResponseV1",
        "TEAM_EMAIL": "TeamEmailNotificationChannelResponseV1",
        "VICTOROPS": "VictorOpsNotificationChannelResponseV1",
        "WEBHOOK": "WebhookNotificationChannelResponseV1",
    }
    ...
    def from_dict(
        ...
        if object_type == "CustomWebhookNotificationChannelResponseV1":
            return import_module(
                "sysdig_client.models.custom_webhook_notification_channel_response_v1"
            ).CustomWebhookNotificationChannelResponseV1.from_dict(obj)
        if object_type == "EmailNotificationChannelResponseV1":
            return import_module(
                "sysdig_client.models.email_notification_channel_response_v1"
            ).EmailNotificationChannelResponseV1.from_dict(obj)
        if object_type == "GchatNotificationChannelResponseV1":
            return import_module(
                "sysdig_client.models.gchat_notification_channel_response_v1"
            ).GchatNotificationChannelResponseV1.from_dict(obj)
        if object_type == "IbmEventNotificationsNotificationChannelResponseV1":
            return import_module(
                "sysdig_client.models.ibm_event_notifications_notification_channel_response_v1"
            ).IbmEventNotificationsNotificationChannelResponseV1.from_dict(obj)
        if object_type == "MsTeamsNotificationChannelResponseV1":
            return import_module(
                "sysdig_client.models.ms_teams_notification_channel_response_v1"
            ).MsTeamsNotificationChannelResponseV1.from_dict(obj)
        if object_type == "OpsgenieNotificationChannelResponseV1":
            return import_module(
                "sysdig_client.models.opsgenie_notification_channel_response_v1"
            ).OpsgenieNotificationChannelResponseV1.from_dict(obj)
        if object_type == "PagerDutyNotificationChannelResponseV1":
            return import_module(
                "sysdig_client.models.pager_duty_notification_channel_response_v1"
            ).PagerDutyNotificationChannelResponseV1.from_dict(obj)
        if object_type == "PrometheusAlertManagerNotificationChannelResponseV1":
            return import_module(
                "sysdig_client.models.prometheus_alert_manager_notification_channel_response_v1"
            ).PrometheusAlertManagerNotificationChannelResponseV1.from_dict(obj)
        if object_type == "SlackNotificationChannelResponseV1":
            return import_module(
                "sysdig_client.models.slack_notification_channel_response_v1"
            ).SlackNotificationChannelResponseV1.from_dict(obj)
        if object_type == "SnsNotificationChannelResponseV1":
            return import_module(
                "sysdig_client.models.sns_notification_channel_response_v1"
            ).SnsNotificationChannelResponseV1.from_dict(obj)
        if object_type == "TeamEmailNotificationChannelResponseV1":
            return import_module(
                "sysdig_client.models.team_email_notification_channel_response_v1"
            ).TeamEmailNotificationChannelResponseV1.from_dict(obj)
        if object_type == "VictorOpsNotificationChannelResponseV1":
            return import_module(
                "sysdig_client.models.victor_ops_notification_channel_response_v1"
            ).VictorOpsNotificationChannelResponseV1.from_dict(obj)
        if object_type == "WebhookNotificationChannelResponseV1":
            return import_module(
                "sysdig_client.models.webhook_notification_channel_response_v1"
            ).WebhookNotificationChannelResponseV1.from_dict(obj)

        raise ValueError(
            "NotificationChannelResponseV1 failed to lookup discriminator value from "
            + json.dumps(obj)
