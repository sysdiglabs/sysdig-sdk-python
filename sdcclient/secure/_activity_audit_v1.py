...
class ActivityAuditClientV1(_SdcCommon):
    ...
    def list_events(self, from_date=None, to_date=None, scope_filter=None, limit=0, data_sources=None):
        """
        ...
        res = self.http.get(
            self.url + "/api/v1/activityAudit/events", headers=self.hdrs, verify=self.ssl_verify, params=query_params
        )
        ...
        while "page" in res and "total" in res["page"] and res["page"]["total"] > number_of_events_per_query:
