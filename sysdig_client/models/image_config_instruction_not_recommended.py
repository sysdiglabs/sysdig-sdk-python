...
class ImageConfigInstructionNotRecommended(BaseModel):
    """
    ...
    def type_validate_enum(cls, value):
        """Validates the enum"""
        if value not in set(['imageConfigInstructionNotRecommended']):
            raise ValueError("must be one of enum values ('imageConfigInstructionNotRecommended')")
        return value
