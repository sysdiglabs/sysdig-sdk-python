...
class WastedWorkloadSpendDataResponse(BaseModel):
    ...
    group_by_data: Optional[Annotated[List[WastedWorkloadSpendDataResponseGroupByDataInner], Field(max_length=10000)]] = Field(default=None, description="Grouped cost data for each combination of Prometheus label values.", alias="groupByData")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "groupByData": [WastedWorkloadSpendDataResponseGroupByDataInner.from_dict(_item) for _item in obj["groupByData"]] if obj.get("groupByData") is not None else None
        })
        return _obj
