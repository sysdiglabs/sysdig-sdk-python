...
class PipelineResultsResponse(BaseModel):
    ...
    data: Optional[Annotated[List[PipelineResult], Field(min_length=0, max_length=1000)]] = None
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "data": [PipelineResult.from_dict(_item) for _item in obj["data"]] if obj.get("data") is not None else None
        })
        return _obj
