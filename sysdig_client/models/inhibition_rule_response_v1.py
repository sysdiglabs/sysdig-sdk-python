...
class InhibitionRuleResponseV1(BaseModel):
    """
    ...
    customer_id: Optional[Annotated[int, Field(le=2147483647, strict=True, ge=0)]] = Field(
        default=None, description="ID of customer that owns the inhibition rule.", alias="customerId"
    )
    team_id: Optional[Annotated[int, Field(le=2147483647, strict=True, ge=0)]] = Field(
        default=None, description="ID of team that owns the inhibition rule.", alias="teamId"
    )
    is_enabled: Optional[StrictBool] = Field(
        default=True, description="Indicates if the inhibition rule is enabled or not.", alias="isEnabled"
    )
    name: Optional[Annotated[str, Field(strict=True, max_length=255)]] = Field(
        default=None, description="Name of the inhibition rule."
    )
    description: Optional[Annotated[str, Field(strict=True, max_length=8192)]] = Field(
        default=None, description="Description of the inhibition rule."
    )
    source_matchers: Optional[Annotated[List[LabelMatcherV1], Field(min_length=1, max_length=100)]] = Field(
        default=None,
        description="List of source matchers for which one or more alerts have to exist for the inhibition to take effect.",
        alias="sourceMatchers",
    )
    target_matchers: Optional[Annotated[List[LabelMatcherV1], Field(min_length=1, max_length=100)]] = Field(
        default=None,
        description="List of target matchers that have to be fulfilled by the target alerts to be muted.",
        alias="targetMatchers",
    )
    equal: Optional[
        Annotated[List[Annotated[str, Field(min_length=1, strict=True, max_length=1024)]], Field(min_length=1, max_length=100)]
    ] = Field(
        default=None,
        ...
        _obj = cls.model_validate(
            {
                ...
                "sourceMatchers": [LabelMatcherV1.from_dict(_item) for _item in obj["sourceMatchers"]]
                if obj.get("sourceMatchers") is not None
                else None,
                "targetMatchers": [LabelMatcherV1.from_dict(_item) for _item in obj["targetMatchers"]]
                if obj.get("targetMatchers") is not None
                else None,
                "equal": obj.get("equal"),
            }
        )
