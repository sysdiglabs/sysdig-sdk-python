...
class UpdatePrometheusAlertManagerNotificationChannelRequestV1(UpdateNotificationChannelRequestV1):
    ...
    __properties: ClassVar[List[str]] = ["teamId", "isEnabled", "name", "hasTestNotificationEnabled", "type", "version", "options"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "options": PrometheusAlertManagerNotificationChannelOptionsV1.from_dict(obj["options"]) if obj.get("options") is not None else None
        })
        return _obj
