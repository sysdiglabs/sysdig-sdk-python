...
class InventoryResourceExtended(BaseModel):
    ...
    image_summary: Optional[Annotated[List[Image], Field(max_length=10000)]] = Field(default=None, description="Images used by the workload (Workloads only)", alias="imageSummary")
    __properties: ClassVar[List[str]] = ["hash", "name", "platform", "type", "category", "lastSeen", "isExposed", "validatedExposure", "labels", "metadata", "resourceOrigin", "posturePolicySummary", "vulnerabilitySummary", "inUseVulnerabilitySummary", "zones", "configApiEndpoint", "postureControlSummaryApiEndpoint", "vmApiEndpoint", "containerInfo", "imageSummary"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "imageSummary": [Image.from_dict(_item) for _item in obj["imageSummary"]] if obj.get("imageSummary") is not None else None
        })
        return _obj
