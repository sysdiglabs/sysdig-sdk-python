...
CREATERISKACCEPTEDREQUESTALLOFCONTEXT_ONE_OF_SCHEMAS = ["List[HostNameContains]", "List[HostName]", "List[ImageNameContains]", "List[ImageName]", "List[ImagePrefix]", "List[ImageSuffix]", "List[PackageNameVersion]", "List[PackageName]", "List[PackagePathVersion]", "List[PackagePath]", "List[PackageVersion]", "List[object]"]
