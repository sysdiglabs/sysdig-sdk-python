...
class AuthenticatedConnectionInfoWebhook(BaseModel):
    """
    ...
    secret: Annotated[str, Field(strict=True, max_length=128)] = Field(
        description='Secret to use, according to the "auth" value.'
    )
