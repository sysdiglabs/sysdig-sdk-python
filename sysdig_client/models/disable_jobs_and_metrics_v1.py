...
class DisableJobsAndMetricsV1(BaseModel):
    ...
    metrics: Optional[Annotated[List[DisableMetricV1], Field(max_length=1000)]] = Field(
        default=None, description="List of metrics to be disabled. "
    )
        ...
        _obj = cls.model_validate(
            {
                ...
                "metrics": [DisableMetricV1.from_dict(_item) for _item in obj["metrics"]]
