...
class GroupMappingsPaginatedResponseV1(BaseModel):
    """
    GroupMappingsPaginatedResponseV1
    """ # noqa: E501
    page: Optional[OffsetPaginatedResponsePage] = None
    data: Optional[Annotated[List[GroupMappingResponseV1], Field(max_length=8192)]] = None
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "data": [GroupMappingResponseV1.from_dict(_item) for _item in obj["data"]] if obj.get("data") is not None else None
        })
        return _obj
