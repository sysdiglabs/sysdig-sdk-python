...
class BundleRule(BaseModel):
    ...
    rule_type: Annotated[str, Field(min_length=1, strict=True, max_length=1024)] = Field(
        description="The type of the rule. It may be one of the following: - vulnSeverityAndThreats - vulnDenyList - imageConfigDefaultUser - imageConfigLabel - imageConfigEnvVariable - imageConfigInstructionNotRecommended - imageConfigInstructionIsPkgManager - imageConfigCreationDate - imageConfigSensitiveInformationAndSecrets - pkgDenyList ",
        alias="ruleType",
    )
    predicates: Annotated[List[BundleRulePredicatesInner], Field(min_length=1, max_length=1000)] = Field(
        description="The Predicates defining this Rule"
    )
    rule_id: Annotated[str, Field(min_length=1, strict=True, max_length=1024)] = Field(alias="ruleId")
    __properties: ClassVar[List[str]] = ["ruleType", "predicates", "ruleId"]
        ...
        _obj = cls.model_validate(
            {
                ...
                "predicates": [BundleRulePredicatesInner.from_dict(_item) for _item in obj["predicates"]]
