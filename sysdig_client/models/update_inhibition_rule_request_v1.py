...
class UpdateInhibitionRuleRequestV1(BaseModel):
    """
    ...
    name: Optional[Annotated[str, Field(strict=True, max_length=255)]] = Field(
        default=None, description="Name of the inhibition rule. If provided, must be unique."
    )
    ...
    source_matchers: Annotated[List[LabelMatcherV1], Field(min_length=1, max_length=100)] = Field(
    ...
    target_matchers: Annotated[List[LabelMatcherV1], Field(min_length=1, max_length=100)] = Field(
        description="List of target matchers that have to be fulfilled by the target alerts to be muted.", alias="targetMatchers"
    )
    equal: Optional[
