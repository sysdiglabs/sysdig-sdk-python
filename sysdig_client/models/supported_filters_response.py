...
class SupportedFiltersResponse(BaseModel):
    ...
    """ # noqa: E501
    data: Annotated[List[SupportedFilter], Field(max_length=1000)] = Field(description="The list of supported attributes for filtering events.")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "data": [SupportedFilter.from_dict(_item) for _item in obj["data"]] if obj.get("data") is not None else None
        })
        return _obj
