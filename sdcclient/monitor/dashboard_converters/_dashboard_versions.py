...
def _convert_dashboard_v1_to_v2(dashboard):
    ...
    def convert_items(prop_name, old_dashboard, new_dashboard):
        ...
        def convert_metrics(prop_name, old_widget, new_widget):
            ...
            timestamp_key = [
                ...
                if m["id"] == "timestamp" and not ("timeAggregation" in m) or not (m["timeAggregation"] is not None)
            ]
            no_timestamp_keys = [
                m
                for m in migrated_metrics
            ...
            values = [m for m in migrated_metrics if "timeAggregation" in m and m["timeAggregation"] is not None]
            if timestamp_key:
    ...
    migrations = {
        ...
        "eventsFilter": with_default(convert_events_filter, {"filterNotificationsUserInputFilter": ""}),
