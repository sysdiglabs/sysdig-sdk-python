...
class RiskAcceptanceDefinition(BaseModel):
    ...
    entity_type: Annotated[str, Field(strict=True, max_length=255)] = Field(
        description="entity type for the risk", alias="entityType"
    )
    entity_value: Annotated[str, Field(strict=True, max_length=1024)] = Field(
        description="entity value relative to the the entity type", alias="entityValue"
    )
    context: Annotated[List[Context], Field(min_length=0, max_length=2147483647)]
    status: StrictStr
    reason: Optional[Annotated[str, Field(strict=True, max_length=255)]] = Field(
        default=None, description="risk acceptance reason"
    )
    description: Optional[Annotated[str, Field(strict=True, max_length=1024)]] = Field(
        default=None, description="risk acceptance description"
    )
