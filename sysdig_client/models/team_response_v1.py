...
class TeamResponseV1(BaseModel):
    ...
    name: Optional[Annotated[str, Field(strict=True, max_length=256)]] = Field(
        default=None, description="The name of the team. It must be unique."
    )
    ...
    is_immutable_team: Optional[StrictBool] = Field(
        default=None,
    ...
    zone_ids: Optional[Annotated[List[Annotated[int, Field(strict=True, ge=0)]], Field(max_length=8192)]] = Field(
        default=None,
    ...
    scopes: Optional[Annotated[List[ScopeV1], Field(max_length=512)]] = Field(
        default=None, description="The scopes available to the users of this team."
    )
    ...
    date_created: Optional[datetime] = Field(
        default=None, description="The date (in ISO 8601 format) when this team was created.", alias="dateCreated"
    )
    last_updated: Optional[datetime] = Field(
        default=None, description="The date (in ISO 8601 format) when this team was last updated.", alias="lastUpdated"
    )
