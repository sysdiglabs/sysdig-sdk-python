...
class NotificationChannel(BaseModel):
    ...
    id: Optional[Annotated[int, Field(le=2147483647000, strict=True, ge=0)]] = Field(
        default=None, description="Notification channel Id"
    )
    type: Optional[Annotated[str, Field(strict=True, max_length=256)]] = Field(
