...
class UpdateWebhookIntegrationRequestAllOfConnectionInfo(BaseModel):
    ...
    secret: Optional[Annotated[str, Field(strict=True, max_length=128)]] = Field(default=None, description="Secret to use, according to the \"auth\" value.")
    __properties: ClassVar[List[str]] = ["endpoint", "isInsecure", "headers", "output", "timestampFormat", "auth", "certificateId", "secret"]
