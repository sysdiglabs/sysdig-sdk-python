...
class InventoryResourceExtended(BaseModel):
    """
    ...
    platform: Annotated[str, Field(strict=True, max_length=256)] = Field(
        description="The resource platform (such as AWS, GCP, Kubernetes, or Azure)"
    )
    ...
    last_seen: Annotated[int, Field(le=9223372036854775616, strict=True, ge=0)] = Field(
        description="Last scan date as unix timestamp", alias="lastSeen"
    )
    is_exposed: Optional[StrictBool] = Field(
        default=None, description="Indicates if a resource is exposed to the internet", alias="isExposed"
    )
    validated_exposure: Optional[StrictBool] = Field(
        default=None,
        description="Indicates if a resource which is exposed to the internet could be reach by our network exposure validator",
        alias="validatedExposure",
    )
    labels: Annotated[List[Annotated[str, Field(strict=True, max_length=8192)]], Field(max_length=10000)] = Field(
        description="The resource labels"
    )
    metadata: Dict[str, Any] = Field(description="The resource metadata")
    resource_origin: Annotated[str, Field(strict=True, max_length=256)] = Field(
        description="Where a resource was collected (Code, Deployed)", alias="resourceOrigin"
    )
    ...
    config_api_endpoint: Optional[Annotated[str, Field(strict=True, max_length=512)]] = Field(
        default=None, description="A link that provides the resource configuration.", alias="configApiEndpoint"
    )
    posture_control_summary_api_endpoint: Optional[Annotated[str, Field(strict=True, max_length=512)]] = Field(
        default=None, description="A link that provides the posture control summary.", alias="postureControlSummaryApiEndpoint"
    )
    vm_api_endpoint: Optional[Annotated[str, Field(strict=True, max_length=512)]] = Field(
        default=None,
        description="A link that provides vulnerability management information about an image (Images only).",
        alias="vmApiEndpoint",
    )
    container_info: Optional[Annotated[List[ContainerInfo], Field(max_length=10000)]] = Field(
        default=None,
        description="List of containers (with some of kubernetes metadata) belonging to this kubernetes workload. If resource is not kubernetes workload this fild will be empty.",
        alias="containerInfo",
    )
    image_summary: Optional[Annotated[List[Image], Field(max_length=10000)]] = Field(
        default=None, description="Images used by the workload (Workloads only)", alias="imageSummary"
    )
    __properties: ClassVar[List[str]] = [
        ...
        "zones",
        "configApiEndpoint",
        "postureControlSummaryApiEndpoint",
        "vmApiEndpoint",
        "containerInfo",
        "imageSummary",
    ]
    ...
    def to_dict(self) -> Dict[str, Any]:
        ...
        * `None` is only added to the output dict for nullable fields that
        ...
        # override the default output from pydantic by calling `to_dict()` of each item in image_summary (list)
        _items = []
        if self.image_summary:
            for _item_image_summary in self.image_summary:
                if _item_image_summary:
                    _items.append(_item_image_summary.to_dict())
            _dict["imageSummary"] = _items
        return _dict
        ...
        _obj = cls.model_validate(
            {
                ...
                "posturePolicySummary": PosturePolicySummary.from_dict(obj["posturePolicySummary"])
                if obj.get("posturePolicySummary") is not None
                else None,
                "vulnerabilitySummary": VulnerabilitySummary.from_dict(obj["vulnerabilitySummary"])
                if obj.get("vulnerabilitySummary") is not None
                else None,
                "inUseVulnerabilitySummary": VulnerabilitySummary.from_dict(obj["inUseVulnerabilitySummary"])
                if obj.get("inUseVulnerabilitySummary") is not None
                else None,
                ...
                "containerInfo": [ContainerInfo.from_dict(_item) for _item in obj["containerInfo"]]
                if obj.get("containerInfo") is not None
                else None,
                "imageSummary": [Image.from_dict(_item) for _item in obj["imageSummary"]]
                if obj.get("imageSummary") is not None
                else None,
            }
        )
        return _obj
