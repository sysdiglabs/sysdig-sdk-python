...
class ImageConfigEnvVariableContains(BaseModel):
    """
    Predicate expressing \"the container has the specified environment variable and value\". 
    """ # noqa: E501
    type: StrictStr
    extra: ImageConfigEnvVariableContainsExtra
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "type": obj.get("type"),
            "extra": ImageConfigEnvVariableContainsExtra.from_dict(obj["extra"]) if obj.get("extra") is not None else None
        })
        return _obj
