...
class SdSecureClientV1(SdSecureClient):
    ...
    def create_default_policies(self):
        ...
        **Success Return Value**
        ...
        """
        res = self.http.post(
            self.url + "/api/policies/createDefault",
            headers=self.hdrs,
    ...
    def delete_all_policies(self):
        ...
        **Success Return Value**
        ...
        """
        res = self.http.post(
            self.url + "/api/policies/deleteAll",
            headers=self.hdrs,
            verify=self.ssl_verify,
        )
    ...
    def get_policy_priorities(self):
        ...
        **Success Return Value**
        ...
        res = self.http.get(
            self.url + "/api/policies/priorities",
            headers=self.hdrs,
            verify=self.ssl_verify,
        )
        return self._request_result(res)
    ...
    def get_policy_id(self, id):
        ...
        **Success Return Value**
        ...
        """
        res = self.http.get(
            self.url + "/api/policies/{}".format(id),
            headers=self.hdrs,
            verify=self.ssl_verify,
        )
        return self._request_result(res)
    ...
    def update_policy(self, policy_json):
        ...
        **Success Return Value**
        ...
        res = self.http.put(
            self.url + "/api/policies/{}".format(policy_obj["id"]),
            headers=self.hdrs,
            data=json.dumps(body),
            verify=self.ssl_verify,
        )
