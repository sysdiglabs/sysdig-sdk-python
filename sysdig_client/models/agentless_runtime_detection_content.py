...
class AgentlessRuntimeDetectionContent(BaseModel):
    ...
    integration_id: Annotated[str, Field(strict=True, max_length=32)] = Field(
        description="The unique identifier of the integration that generated the event.", alias="integrationId"
    )
    ...
    rule_tags: Optional[Annotated[List[Annotated[str, Field(strict=True, max_length=64)]], Field(max_length=1000)]] = Field(
        default=None, description="The tags attached to the rule", alias="ruleTags"
    )
    ...
    policy_notification_channel_ids: Optional[
    ...
    output: Optional[Annotated[str, Field(strict=True, max_length=2048)]] = Field(
        default=None, description="Event output, generated after the configured rule"
    )
    ...
    def priority_validate_enum(cls, value):
        ...
        if value not in set(["emergency", "alert", "critical", "error", "warning", "informational", "notice", "debug"]):
            raise ValueError(
                "must be one of enum values ('emergency', 'alert', 'critical', 'error', 'warning', 'informational', 'notice', 'debug')"
            )
        return value
        ...
        _obj = cls.model_validate(
            {
                ...
                "fields": AgentlessRuntimeDetectionContentAllOfFields.from_dict(obj["fields"])
