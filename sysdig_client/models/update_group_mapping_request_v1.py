...
class UpdateGroupMappingRequestV1(BaseModel):
    ...
    weight: Annotated[int, Field(le=32767, strict=True, ge=1)] = Field(description="The weight of the group mapping that is used to determine the priority - a lower number has higher priority.")
