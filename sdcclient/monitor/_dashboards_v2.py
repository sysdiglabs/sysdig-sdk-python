...
class DashboardsClientV2(_SdcCommon):
    def __init__(
        ...
        super(DashboardsClientV2, self).__init__(
        ...
        self._default_dashboards_api_endpoint = "/api/{}/defaultDashboards".format(
            self._dashboards_api_version
        )
        ...
        **Example**
        ...
        for i, metric in enumerate(metrics):
            ...
            panel_configuration["metrics"].append(
                {
                    "id": metric["id"],
                    "timeAggregation": metric["aggregations"]["time"]
        ...
        panel_configuration["overrideScope"] = (
    ...
    def create_dashboard_from_template(
        self, dashboard_name, template, scope, shared=False, public=False
    ):
    ...
    def create_dashboard_from_dashboard(
        self, newdashname, templatename, filter, shared=False, public=False
    ):
        """**Description**
        ...
        **Example**
        ...
        #
        return self.create_dashboard_from_template(
            newdashname, dboard, filter, shared, public
        )

    def create_dashboard_from_file(
        self, dashboard_name, filename, filter, shared=False, public=False
    ):
        """
        **Description**
