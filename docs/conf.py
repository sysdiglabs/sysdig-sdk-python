...
latex_documents = [
    (master_doc, "python-sdc-client.tex", "python-sdc-client Documentation", "Sysdig Inc.", "manual"),
]
...
man_pages = [(master_doc, "python-sdc-client", "python-sdc-client Documentation", [author], 1)]
