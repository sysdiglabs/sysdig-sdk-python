...
class BundleRule(BaseModel):
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "predicates": [BundleRulePredicatesInner.from_dict(_item) for _item in obj["predicates"]] if obj.get("predicates") is not None else None,
