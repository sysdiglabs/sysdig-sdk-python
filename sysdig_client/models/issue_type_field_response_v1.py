...
class IssueTypeFieldResponseV1(BaseModel):
    ...
    jira_id: Annotated[str, Field(strict=True, max_length=512)] = Field(
        description="Issue type field id on Jira.", alias="jiraId"
    )
    jira_name: Annotated[str, Field(strict=True, max_length=512)] = Field(
        description="Jira issue type field name.", alias="jiraName"
    )
    ...
    allowed_values: Optional[Annotated[List[IssueTypeFieldResponseV1AllowedValuesInner], Field(max_length=500)]] = Field(
        default=None, description="Allowed values for the field.", alias="allowedValues"
    )
        ...
        _obj = cls.model_validate(
            {
                ...
                "allowedValues": [IssueTypeFieldResponseV1AllowedValuesInner.from_dict(_item) for _item in obj["allowedValues"]]
                if obj.get("allowedValues") is not None
                else None,
            }
        )
        return _obj
