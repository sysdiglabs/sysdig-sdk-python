...
class QueryResponseEntities(BaseModel):
    """
    Metadata about the returned fields.
    """ # noqa: E501
    fields: Optional[EntityDefinition] = None
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "fields": EntityDefinition.from_dict(obj["fields"]) if obj.get("fields") is not None else None
        })
