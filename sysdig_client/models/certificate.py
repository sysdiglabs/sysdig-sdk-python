...
class Certificate(BaseModel):
    ...
    certificate_name: Annotated[str, Field(strict=True, max_length=200)] = Field(
        description="The certificate Name.", alias="certificateName"
    )
    created: datetime = Field(description="The timestamp the certificate was created.")
    issuer: Annotated[str, Field(strict=True, max_length=2000)] = Field(
        description="The Distinguished Name of the certificate issuer."
    )
    validity: CertificateValidity
    usage: Annotated[int, Field(le=2147483647, strict=True, ge=0)] = Field(
        description="The number of services that currently use that certificate."
    )
