...
class AuditTrailContent(BaseModel):
    ...
    username: Optional[Annotated[str, Field(strict=True, max_length=64)]] = Field(default=None, description="Username of the user that was preforming some action.")
    ...
    entity_id: Optional[Annotated[str, Field(strict=True, max_length=64)]] = Field(default=None, description="ID of the entity that was affected by the action.", alias="entityId")
