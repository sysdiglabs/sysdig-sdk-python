...
class UnitPricingV1(BaseModel):
    ...
    spot_cpu: Optional[Union[StrictFloat, StrictInt]] = Field(
        default=None, description="Hourly cost of one CPU for a spot node.", alias="spotCpu"
    )
    spot_ram: Optional[Union[StrictFloat, StrictInt]] = Field(
        default=None, description="Hourly cost of one GB of RAM for a spot node.", alias="spotRam"
    )
