...
class GroupMappingResponseV1(BaseModel):
    ...
    group_name: Optional[Annotated[str, Field(strict=True, max_length=256)]] = Field(
        default=None, description="The group name matching the external provider name.", alias="groupName"
    )
    ...
    is_admin: Optional[StrictBool] = Field(
        default=None, description="Flag that indicates if the group is an admin group.", alias="isAdmin"
    )
    team_map: Optional[TeamMapV1] = Field(default=None, alias="teamMap")
    weight: Optional[Annotated[int, Field(le=32767, strict=True, ge=1)]] = Field(
        default=None,
    ...
    date_created: Optional[datetime] = Field(
        default=None, description="The date in which this group mapping was created in ISO 8601 format.", alias="dateCreated"
    )
    last_updated: Optional[datetime] = Field(
        default=None, description="The date in which this group mapping was last updated in ISO 8601 format.", alias="lastUpdated"
    )
