...
class SbomResultResponse(BaseModel):
    ...
    spec_version: Annotated[str, Field(strict=True, max_length=512)] = Field(
        description="The version of the CycloneDX specification a BOM conforms to (starting at version 1.2).", alias="specVersion"
    )
    serial_number: Optional[Annotated[str, Field(strict=True, max_length=512)]] = Field(
        default=None,
    ...
    version: Optional[Annotated[int, Field(le=2147483647, strict=True, ge=1)]] = Field(
        default=1,
    ...
    components: Optional[Annotated[List[SbomComponent], Field(max_length=1000000)]] = Field(
        default=None, description="A list of software and hardware components."
    )
    dependencies: Optional[Annotated[List[Dependency], Field(max_length=1000000)]] = Field(
        default=None, description="Provides the ability to document dependency relationships."
    )
    compositions: Optional[Annotated[List[CompositionsInner], Field(max_length=1000000)]] = Field(
        default=None,
        ...
        _obj = cls.model_validate(
            {
                ...
                "components": [SbomComponent.from_dict(_item) for _item in obj["components"]]
                if obj.get("components") is not None
                else None,
                "dependencies": [Dependency.from_dict(_item) for _item in obj["dependencies"]]
                if obj.get("dependencies") is not None
                else None,
                "compositions": [CompositionsInner.from_dict(_item) for _item in obj["compositions"]]
