...
class IntegrationResponse(BaseModel):
    ...
    def actual_instance_must_validate_oneof(cls, v):
        ...
        if match > 1:
            # more than 1 match
            raise ValueError(
                "Multiple matches found when setting `actual_instance` in IntegrationResponse with oneOf schemas: GetAmazonSqsIntegrationResponse, GetChronicleIntegrationResponse, GetElasticsearchIntegrationResponse, GetGooglePubSubIntegrationResponse, GetGoogleSccIntegrationResponse, GetKafkaIntegrationResponse, GetMcmIntegrationResponse, GetMicrosoftSentinelIntegrationResponse, GetQradarIntegrationResponse, GetSplunkIntegrationResponse, GetSyslogIntegrationResponse, GetWebhookIntegrationResponse. Details: "
                + ", ".join(error_messages)
            )
        elif match == 0:
            # no match
            raise ValueError(
                "No match found when setting `actual_instance` in IntegrationResponse with oneOf schemas: GetAmazonSqsIntegrationResponse, GetChronicleIntegrationResponse, GetElasticsearchIntegrationResponse, GetGooglePubSubIntegrationResponse, GetGoogleSccIntegrationResponse, GetKafkaIntegrationResponse, GetMcmIntegrationResponse, GetMicrosoftSentinelIntegrationResponse, GetQradarIntegrationResponse, GetSplunkIntegrationResponse, GetSyslogIntegrationResponse, GetWebhookIntegrationResponse. Details: "
                + ", ".join(error_messages)
            )
        else:
            return v
