...
class Services(BaseModel):
    ...
    certificate_id: Annotated[int, Field(le=9223372036854775616, strict=True, ge=0)] = Field(
        description="The certificate ID.", alias="certificateId"
    )
    ...
    service_id: Annotated[str, Field(strict=True, max_length=20)] = Field(
        description="The integration ID for the service owning the integration that uses the certificate.", alias="serviceId"
    )
