...
class IntegrationChannelsResponse(BaseModel):
    """
    Integration Channels Response
    """ # noqa: E501
    data: Annotated[List[IntegrationChannel], Field(max_length=32)] = Field(description="Data types to forward. Must be compatible with the specified Integration type")
