...
class ListAuditEventsResponse(BaseModel):
    ...
    """ # noqa: E501
    page: AuditPage
    data: Annotated[List[AuditEvent], Field(max_length=999)] = Field(description="The list of Audit events.")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "page": AuditPage.from_dict(obj["page"]) if obj.get("page") is not None else None,
