...
class VulnAge(BaseModel):
    ...
    def type_validate_enum(cls, value):
        """Validates the enum"""
        if value not in set(["vulnAge"]):
            raise ValueError("must be one of enum values ('vulnAge')")
        return value
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate(
            {"type": obj.get("type"), "extra": VulnAgeExtra.from_dict(obj["extra"]) if obj.get("extra") is not None else None}
        )
        return _obj
