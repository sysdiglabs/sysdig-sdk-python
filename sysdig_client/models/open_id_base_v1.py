...
class OpenIdBaseV1(BaseModel):
    ...
    __properties: ClassVar[List[str]] = ["issuerUrl", "clientId", "isMetadataDiscoveryEnabled", "metadata", "groupAttributeName", "isAdditionalScopesCheckEnabled", "additionalScopes"]
