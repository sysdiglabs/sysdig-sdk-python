...
from sysdig_client.api_response import ApiResponse, T as ApiResponseT
import sysdig_client.models
from sysdig_client import rest
    ...
    def __deserialize(self, data, klass):
        ...
        if isinstance(klass, str):
            ...
            if klass in self.NATIVE_TYPES_MAPPING:
                ...
                klass = getattr(sysdig_client.models, klass)
