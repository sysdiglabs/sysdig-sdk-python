...
class RequestBodyDisabledMetricsV1(BaseModel):
    """
    Change Disabled Metrics per JobName
    """ # noqa: E501
    data: Annotated[List[DisableJobsAndMetricsV1], Field(max_length=1000)]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "data": [DisableJobsAndMetricsV1.from_dict(_item) for _item in obj["data"]] if obj.get("data") is not None else None
        })
        return _obj
