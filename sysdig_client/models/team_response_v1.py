...
class TeamResponseV1(BaseModel):
    """
    TeamResponseV1
    """ # noqa: E501
    id: Optional[Annotated[int, Field(strict=True, ge=0)]] = Field(default=None, description=" ")
    name: Optional[Annotated[str, Field(strict=True, max_length=256)]] = Field(default=None, description="The name of the team. It must be unique.")
    description: Optional[Annotated[str, Field(strict=True, max_length=2048)]] = Field(default=None, description="A description of the team explaining what is it used for.")
    is_immutable_team: Optional[StrictBool] = Field(default=None, description="Specifies if the team is immutable. This is true if the team was created by the system with full access. It cannot be modified.", alias="isImmutableTeam")
    ...
    standard_team_role: Optional[TeamRoleV1] = Field(default=None, description="The standard team role assigned by default to users added to this team. Mutually exclusive with 'customTeamRoleId'. ", alias="standardTeamRole")
    ...
    product: Optional[Product] = Field(default=None, description="The product to which the team is assigned to.")
    ui_settings: Optional[UiSettingsV1] = Field(default=None, alias="uiSettings")
    is_all_zones: Optional[StrictBool] = Field(default=None, description="'True' if the users belonging to this team have access to all zones. Mutually exclusive with 'zoneIds'. ", alias="isAllZones")
    zone_ids: Optional[Annotated[List[Annotated[int, Field(strict=True, ge=0)]], Field(max_length=8192)]] = Field(default=None, description="The list of zones that users assigned to this team will have access to. Mutually exclusive with 'allZones'. ", alias="zoneIds")
    scopes: Optional[Annotated[List[ScopeV1], Field(max_length=512)]] = Field(default=None, description="The scopes available to the users of this team.")
    additional_team_permissions: Optional[AdditionalTeamPermissionsV1] = Field(default=None, alias="additionalTeamPermissions")
    date_created: Optional[datetime] = Field(default=None, description="The date (in ISO 8601 format) when this team was created.", alias="dateCreated")
    last_updated: Optional[datetime] = Field(default=None, description="The date (in ISO 8601 format) when this team was last updated.", alias="lastUpdated")
    version: Optional[Annotated[int, Field(strict=True, ge=0)]] = Field(default=None, description=" ")
    __properties: ClassVar[List[str]] = ["id", "name", "description", "isImmutableTeam", "isDefaultTeam", "standardTeamRole", "customTeamRoleId", "product", "uiSettings", "isAllZones", "zoneIds", "scopes", "additionalTeamPermissions", "dateCreated", "lastUpdated", "version"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "isImmutableTeam": obj.get("isImmutableTeam"),
