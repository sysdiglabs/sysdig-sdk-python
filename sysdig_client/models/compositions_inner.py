...
class CompositionsInner(BaseModel):
    ...
    assemblies: Optional[Annotated[List[Annotated[str, Field(strict=True, max_length=512)]], Field(max_length=1000000)]] = Field(
        default=None,
    ...
    dependencies: Optional[Annotated[List[Annotated[str, Field(strict=True, max_length=512)]], Field(max_length=1000000)]] = (
        Field(
            default=None,
            description="The bom-ref identifiers of the components or services being described. Assemblies refer to nested relationships whereby a constituent part may include other constituent parts. References do not cascade to child parts. References are explicit for the specified constituent part only.",
        )
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate(
            {"aggregate": obj.get("aggregate"), "assemblies": obj.get("assemblies"), "dependencies": obj.get("dependencies")}
        )
        return _obj
