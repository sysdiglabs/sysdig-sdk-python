...
class CreateUserRequestV1(BaseModel):
    ...
    """ # noqa: E501
    email: Annotated[str, Field(strict=True, max_length=512)] = Field(description="The email address of the user. If the activation flow is set, this address will be used to send the activation email. ")
