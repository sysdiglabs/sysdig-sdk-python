...
class ListIntegrationsResponse(BaseModel):
    ...
    """ # noqa: E501
    data: Annotated[List[IntegrationResponse], Field(max_length=512)]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "data": [IntegrationResponse.from_dict(_item) for _item in obj["data"]] if obj.get("data") is not None else None
        })
        return _obj
