...
class RulesResponseV1Data(BaseModel):
    """
    Response payload containing rule groups.
    """ # noqa: E501
    groups: Optional[List[RulesResponseV1DataGroupsInner]] = Field(default=None, description="List of rule groups.")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "groups": [RulesResponseV1DataGroupsInner.from_dict(_item) for _item in obj["groups"]] if obj.get("groups") is not None else None
        })
        return _obj
